...
import { AiFillClockCircle, AiOutlineClockCircle, AiOutlineFire, AiTwotoneClockCircle } from 'react-icons/ai';
    ...
    return <>
        <div className="flex flex-col gap-5">
            <div className="px-10  py-5 flex items-center gap-3">
                ...
                <h1 className="gradient-text font-bold text-2xl uppercase ">History</h1>
            </div>
