...
import { UserTile } from "@/components/user/brief";
import { faFireFlameCurved, faHouseFire } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { AiFillClockCircle, AiOutlineBook, AiOutlineClockCircle, AiOutlineFire, AiOutlineUser, AiTwotoneClockCircle } from 'react-icons/ai';
    ...
    return <>
        <div className="flex flex-col gap-5">
            <div className="px-10  py-5 flex items-center gap-3">
                ...
                <h1 className="gradient-text font-bold text-2xl uppercase ">Favorite Users</h1>
            </div>
